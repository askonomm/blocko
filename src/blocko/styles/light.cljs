...
(def add-block-menu
  {:display "block"
   ...
   :height "auto"
   :background "#fbfbfb"
   :box-shadow "0px 3px 20px rgba(0,0,0,.025), 0px 0px 50px rgba(0,0,0,.025)"
...
(def theme
  {:container container
   ...
   :add-block-menu-list-item-icon-color "#111111"
